...
export const site = {
  name: "高校课程资源导航",
  desc: "通用的开源高校课程资源导航与阅读站模板",
  url: "https://courses.example.edu.cn",
  avatar: "/favicon/firefly-32.png",
  email: "opensource@example.edu.cn",
};

{/* ========= 收录原则 ========== */}

export const notes = [
  { title: "高校开源", content: "优先收录各大高校学生组织或个人发起的高质量开源课程攻略与资料项目" },
  { title: "持续维护", content: "项目具有清晰的分类结构与持续更新的良好社区维护状态" },
  { title: "互惠互通", content: "欢迎兄弟院校在友链或相关推荐中互相链接，共同壮大开源校园力量" },
  { title: "合法合规", content: "资料内容合法合规，不涉及未公开试卷窃取或商业侵权" },
];
