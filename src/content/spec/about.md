...
- **打破信息孤岛**：大学课程很多，但哪门课给分好？实验怎么避坑？期末考重点是什么？我们希望把这些宝贵经验沉淀为公开透明的指南。
- **开源共建模式**：借鉴清华、北大、浙大、中科大等顶尖高校的开源课程攻略精神，每位同学都可以通过 GitHub 提交 PR 贡献经验与资料。
- **现代化阅读体验**：基于 Astro 7 + Svelte 5 构建，原生支持 KaTeX 数学公式渲染、Mermaid 架构流程图与 Pagefind 全文离线毫秒级搜索。
